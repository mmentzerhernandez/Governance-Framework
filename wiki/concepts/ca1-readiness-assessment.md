...
| Instrument | Role | Cost | Output |
|---|---|---|---|
| [[unesco-ram]] | Government self-diagnosis + strategy gap analysis | Zero (UNESCO-facilitated) | Readiness report + priority matrix |
| [[oxford-insights-gari]] | External benchmark + peer comparison | Zero (public data) | Scores across 3 pillars |
| [[imf-ai-preparedness-index]] | Macro-economic fit | Zero (IMF data) | Scores across 4 dimensions, 174 countries |
