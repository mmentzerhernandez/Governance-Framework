...
|---|---|---|---|
| **Diagnose** | Months 1–9 | Complete the [[unesco-ram]] and extract [[imf-ai-preparedness-index]] dimensions to outline strategic deficiencies → [[diagnostic-anchor]] | Near-zero |
| **Anchor** | Months 6–18 | Enact a ministerial AI governance circular, deploy the [[canada-directive-adm]] AIA for procurement, and host a basic public incident complaints channel → [[procurement-lever]] · [[regulatory-lever]] · [[redress-focal-point]] | Low (staff time) |
| **Protect** | Months 12–24 | Apply the [[vendor-lock-in-dpi-test]] to incoming infrastructure and insert [[eu-ai-act]] conformity clauses into high-stakes contracts → [[infrastructure-safeguard]] | Low–medium |
| **Engage** | Months 18–36 | Coordinate within G77, AU, CARICOM, or ASEAN to submit cohesive text changes built on domestic impact dossiers → [[ca5-multilateral-negotiating-playbook]] · [[ca7-regional-infrastructure]] | Medium |
| **Monitor** | Ongoing | Integrate the [[ilo-automation-methodology]] Automation Exposure Index and add automated-exclusion questions to household surveys → [[protection-survey]] | Medium |
