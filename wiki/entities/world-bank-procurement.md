...
**Capability area:** [[ca3-harm-reporting-redress]] (CA3-BP4)

## What it is
Governs all IBRD/IDA-financed procurement. For digital/AI systems, the Procurement Regulations
require contract provisions for system documentation & source-code escrow, data ownership &
portability, audit rights, performance benchmarking, and dispute resolution. The 2023–2024 AI
guidance adds algorithmic-transparency documentation, bias-testing records, incident-reporting
obligations, and **exit/transition planning** (the most lock-in-relevant clause).
