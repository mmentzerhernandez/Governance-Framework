---
title: Green Climate Fund Direct Access Modality
type: entity
...
**Year:** modality established COP16 (2010); operational 2015–ongoing
**Capability area:** [[ca4-development-finance-lock-in]] (CA4-BP3)

## What it is
Lets developing-country governments and regional bodies receive climate finance **directly**
through accredited national implementing entities (NIEs), bypassing MDB intermediation. Three
features map to AI-infrastructure finance: **national ownership** (the NIE controls disbursement),
**pooled programming** (small countries pool allocations under a regional body), and
**conditionality limitation** (project conditions negotiated upfront and locked, preventing
ex-post donor modification). The Readiness Programme grants up to $3m/country for capacity-building.
